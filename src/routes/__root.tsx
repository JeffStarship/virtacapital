  ...
  head: () => ({
    meta: [
      ...
      { title: "Virta Capital — Alavancagem Patrimonial" },
      {
        name: "description",
        content:
          "Estratégias de alavancagem patrimonial com cartas de crédito contempladas. Parceiro autorizado do Consórcio Canopus.",
      },
      { property: "og:title", content: "Virta Capital — Alavancagem Patrimonial" },
      {
        property: "og:description",
        content:
          "Transforme ativos parados em capital produtivo — sem banco, sem venda.",
      },
